...
server in gqlgen. You can find the finished result in the [examples directory](https://github.com/norbux/gqlgen/tree/master/example/federation).
...
```bash
go run github.com/norbux/gqlgen
```
